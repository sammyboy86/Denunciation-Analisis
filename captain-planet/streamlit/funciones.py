...
def actualizar_colonias_gral(df_externo, alcaldia, colonia, colonias_matched):

    for index in range(colonias_matched.shape[0]):
        df_externo.loc[(df_externo[alcaldia]==colonias_matched.loc[index,'alcaldia'])&(df_externo[colonia]==colonias_matched.loc[index,'colonia_vieja']), colonia] =  colonias_matched.loc[index,'colonia_nueva']    
