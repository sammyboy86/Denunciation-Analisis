...
def actualizar_colonias_gral(df_externo, alcaldia_externo,colonia_externo,colonias_matched):
    for i in range(colonias_matched.shape[0]):
        df_externo.loc[(df_externo[alcaldia_externo]==colonias_matched.iloc[i,0])&(df_externo[colonia_externo]==colonias_matched.iloc[i,1]), colonia_externo]  = colonias_matched.iloc[i,2]    
